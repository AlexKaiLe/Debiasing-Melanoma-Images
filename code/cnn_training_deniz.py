...
class Model(tf.keras.Model):
	...
	def __init__(self):
		...
		self.batch_size = 100 #used to be 64
		self.num_classes = 9

		self.lr = 0.0005 # learning rate for optimizer #used to be 0.0005
		...
		# Block 1
		self.block1_conv1 = Conv2D(32, 3, 1, padding="same", activation="leaky_relu", name="block1_conv1")
		self.block1_conv2 = Conv2D(32, 3, 1, padding="same", activation="leaky_relu", name="block1_conv2")
		# Block 2
		self.block2_conv1 = Conv2D(64, 3, 1, padding="same", activation="leaky_relu", name="block2_conv1")
		self.block2_conv2 = Conv2D(64, 3, 1, padding="same", activation="leaky_relu", name="block2_conv2")
		# Block 3
		self.block3_conv1 = Conv2D(128, 3, 1, padding="same", activation="leaky_relu", name="block3_conv1")
		self.block3_conv2 = Conv2D(128, 3, 1, padding="same", activation="leaky_relu", name="block3_conv2")
		self.block3_conv3 = Conv2D(128, 3, 1, padding="same", activation="leaky_relu", name="block3_conv3")
		# Block 4
		...
		self.dense2 = Dense(9, activation='sigmoid', name='dense2')
	...
	def loss(self, probs, labels):
		...
		return tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels, probs, axis = 1))
...
def main():
	...
	for e in range(model.epochs):
		...
		loss_list = train(model, train_dataset)
